function returnval = a2(wd_coefficient, n_hid, n_iters, learning_rate, momentum_multiplier, do_early_stopping, mini_batch_size)
  ...
  for data_i = 1:3,
    ...
    if strcmp(data_name,'validation') ~= 0
        returnval = loss(model,data,0);
    end
