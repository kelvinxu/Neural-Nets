function [testloss] = a4(datas, wd_coefficient, pretrained_model, n_iters, learning_rate, momentum_multiplier, do_early_stopping, mini_batch_size)
...
warning('error', 'Octave:broadcast');
  ...
  n_hid = size(model.input_to_hid, 1);
